...
public class ClienteDAO implements DAO<Cliente> {
    ...
    public boolean insere(Cliente dado) throws SQLException {
        ...
        String sql = "INSERT INTO clientes (nomeCliente, nascCliente, enderecoCliente, emailCliente) values (?, ?, ?, ?)";
    ...
    public boolean altera(Cliente dado) throws SQLException {
        ...
        String sql = "UPDATE clientes SET nomeCliente = ?, nascCliente = ?,"
                + " enderecoCliente = ?, emailCliente = ? WHERE codBruxo = ?";
    ...
    public boolean clienteVenda(Cliente dado) throws SQLException {
        boolean existe;
        Banco.conectar();

        String sql = "SELECT codVend FROM Venda WHERE codBruxo = ?";
